...
},{"./ajax_setup":1,"./router":3,"jquery":11}],3:[function(require,module,exports){
'use strict';
...
var _todos_collection = require('./todos_collection');

var _todos_collection2 = _interopRequireDefault(_todos_collection);
...
var _viewsTodo = require('./views/todo');

var _viewsTodo2 = _interopRequireDefault(_viewsTodo);
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.todos = new _todos_collection2['default']();
  ...
  showSpecificTodo: function showSpecificTodo(todoId) {
    var _this = this;
    ...
    if (todo) {
      ...
      this.$el.html((0, _viewsTodo2['default'])(todo.toJSON()));
    } else {
      (function () {
        // todos not fetched so we need to load the one we want
        var router = _this;
        todo = _this.todos.add({ objectId: todoId });
        _this.showSpinner();
        todo.fetch().then(function () {
          router.$el.html((0, _viewsTodo2['default'])(todo.toJSON()));
        });
      })();
    }
  },
  ...
  showTodos: function showTodos() {
    ...
    this.todos.fetch().then(function () {
      ...
      router.$el.html((0, _viewsTodos2['default'])(router.todos.toJSON()));
    });
  },
...
},{"./todos_collection":5,"./views/home":6,"./views/todo":7,"./views/todos":8,"backbone":10,"jquery":11}],4:[function(require,module,exports){
'use strict';
...
},{"./todo_model":4,"backbone":10}],6:[function(require,module,exports){
"use strict";
...
function homeTemplate() {
  return "\n    \n    <h2><a href=\"#todos\">Home page<br>Click to enter my Halloween contacts.  Enter only if you dare!<br>Call one of them if you're truly mad!!!</h2>\n\n  ";
}
...
},{"moment":12}],8:[function(require,module,exports){
'use strict';
